...
export default function WaiverTable({ data, handleTracking, isPending, setModalActive }) {
  ...
  return (
    <table className='text-center mx-auto animate-fadein w-1/2'>
        <thead>
            <tr className=''>
                <th className='p-4 border-4 border-secondary underline underline-offset-4 text-xl w-1/12'>Pick</th>
                <th className='p-4 border-4 border-secondary underline underline-offset-4 text-xl w-1/12'>Round</th>
