...
export default function WaiverStats({ data }) {
  ...
  return (
    <div className='flex flex-col gap-4 border-2 border-secondary mb-12 rounded-xl p-4 mx-auto w-11/12 lg:w-3/4'>
        <div className="mx-auto py-2 px-4 flex justify-center items-center gap-2 rounded-full border-2 border-tertiary lg:w-1/2 transition ease-in hover:bg-tertiary hover:text-primary duration-150" onClick={() => setShowStats(showStats ? false : true)}>
        ...
        { showStats && <div className="overflow-x-auto">
